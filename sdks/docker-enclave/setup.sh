...
mount -t ecryptfs /app/nfs-encrypted /app/nfs_mount -o ecryptfs_cipher=aes,ecryptfs_key_bytes=16,ecryptfs_passthrough=no,ecryptfs_enable_filename_crypto=no
